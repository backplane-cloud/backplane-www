...
image: { src: "/assets/terminaloutline.svg", alt: "Command Line Interface" }
category: "reference"
author: "Lewis Sheridan"
tags: []
---

This guide covers all the basic commands and options.

Use `bp <subcommand> -h` for help on options available for each command.

For CLI Installation instructions, click [here](/blog/cli)
